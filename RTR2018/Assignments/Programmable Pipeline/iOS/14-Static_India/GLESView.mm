...
-(void)drawView:(id)sender
{
    ...
    msd_translationMatrix = vmath::translate(0.2f, 0.0f, 0.0f);
    ...
    msd_translationMatrix = vmath::translate(1.6f, 0.0f, 0.0f);
    msd_modelViewMatrix = msd_translationMatrix * msd_modelViewMatrix;
    //do necessary matrix multiplication
    msd_modelViewProjectionMatrix = msd_perspectiveProjectionMatrix * msd_modelViewMatrix;
    ...
    glBindVertexArray(0);
    msd_modelViewMatrix = vmath::mat4::identity();
    msd_translationMatrix = vmath::translate(0.2f, 0.0f, -3.0f);
    ...
    msd_modelViewMatrix = vmath::mat4::identity();
    msd_translationMatrix = vmath::translate(1.055f, 0.0f, -3.0f);
    msd_modelViewMatrix = msd_translationMatrix * msd_scaleMatrix*msd_modelViewMatrix;
    //do necessary matrix multiplication
    msd_modelViewProjectionMatrix = msd_perspectiveProjectionMatrix * msd_modelViewMatrix;
    ...
    msd_modelViewMatrix = vmath::mat4::identity();
    msd_translationMatrix = vmath::translate(1.15f, 0.0f, -3.0f);
    msd_modelViewMatrix = msd_translationMatrix *msd_modelViewMatrix;
    //do necessary matrix multiplication
    msd_modelViewProjectionMatrix = msd_perspectiveProjectionMatrix * msd_modelViewMatrix;
