...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Direct3D11 Perspective Rectangle using 4 Vertices"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
HRESULT initialize()
{
	...
	float vertices[] = {
		-1.0f,1.0f,0.0f,//lefttop
		1.0f,1.0f,0.0f,//righttop
...
void display()
{
	...
	msd_gpID3D11DeviceContext->Draw(4,0);//no quads suing 2 triangles lt,rt,lb,rb clockwise
