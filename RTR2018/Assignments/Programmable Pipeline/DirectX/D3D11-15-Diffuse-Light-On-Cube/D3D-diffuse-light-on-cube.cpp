...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("D3D11 Diffuse Light on Cube"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
HRESULT initialize()
{
	...
	bufferDesc_NormalBuffer_Cube.ByteWidth = sizeof(float)*_ARRAYSIZE(cubeNormal);
	...
	memcpy(mappedSubResource_normal_cube.pData,cubeNormal,sizeof(cubeNormal));
...
void display()
{
	...
	if (gbIsLighting == true)
	{
		...
		constantBuffer.LightPosition = XMVectorSet(0.0,0.0,7.0,1.0);
	}
	else
	{
