...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        glBufferData(GL_ARRAY_BUFFER, 500 * 3 * sizeof(GL_FLOAT),
...
-(void)drawView:(id)sender
{
    ...
    msd_linesCoordinates[0] = 0.70f;
    msd_linesCoordinates[1] = 0.70f;
    msd_linesCoordinates[2] = 0.0f;
    msd_linesCoordinates[3] = -0.70f;
    msd_linesCoordinates[4] = 0.70f;
    msd_linesCoordinates[5] = 0.0f;
    msd_linesCoordinates[6] = -0.70f;
    msd_linesCoordinates[7] = -0.70f;
    msd_linesCoordinates[8] = 0.0f;
    msd_linesCoordinates[9] = 0.70f;
    msd_linesCoordinates[10] = -0.70f;
    msd_linesCoordinates[11] = 0.0f;
    for (int i = 0; i < 12; i = i + 3)
    {
        msd_colorCoordinates[i + 0] = 1.0f;
        msd_colorCoordinates[i + 1] = 1.0f;
        msd_colorCoordinates[i + 2] = 0.0f;
    }
    ...
    msd_translationMatrix = vmath::translate(0.0f, -0.265f, 0.0f);
