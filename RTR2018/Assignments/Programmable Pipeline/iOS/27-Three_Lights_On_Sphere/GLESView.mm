...
@private
    ...
    GLuint msd_vUniform;
    GLuint msd_pUniform;
    GLuint msd_laUniform_red;
    GLuint msd_ldUniform_red;
    GLuint msd_lsUniform_red;
    GLuint msd_lightPositionUniform_red;
    GLuint msd_laUniform_blue;
    GLuint msd_ldUniform_blue;
    GLuint msd_lsUniform_blue;
    GLuint msd_lightPositionUniform_blue;
    GLuint msd_laUniform_green;
    GLuint msd_ldUniform_green;
    GLuint msd_lsUniform_green;
    GLuint msd_lightPositionUniform_green;
...
-(void)shaderTogglePerFragment
{
    ...
    msd_laUniform_red = glGetUniformLocation(msd_gShaderProgramObject, "u_la_red");
    msd_ldUniform_red = glGetUniformLocation(msd_gShaderProgramObject, "u_ld_red");
    msd_lsUniform_red = glGetUniformLocation(msd_gShaderProgramObject, "u_ls_red");
    msd_lightPositionUniform_red = glGetUniformLocation(msd_gShaderProgramObject, "u_lightPosition_red");
    msd_laUniform_blue = glGetUniformLocation(msd_gShaderProgramObject, "u_la_blue");
    msd_ldUniform_blue = glGetUniformLocation(msd_gShaderProgramObject, "u_ld_blue");
    msd_lsUniform_blue = glGetUniformLocation(msd_gShaderProgramObject, "u_ls_blue");
    msd_lightPositionUniform_blue = glGetUniformLocation(msd_gShaderProgramObject, "u_lightPosition_blue");
    msd_laUniform_green = glGetUniformLocation(msd_gShaderProgramObject, "u_la_green");
    msd_ldUniform_green = glGetUniformLocation(msd_gShaderProgramObject, "u_ld_green");
    msd_lsUniform_green = glGetUniformLocation(msd_gShaderProgramObject, "u_ls_green");
    msd_lightPositionUniform_green = glGetUniformLocation(msd_gShaderProgramObject, "u_lightPosition_green");
...
-(void)shaderTogglePerVertex
{
    ...
    msd_laUniform_red = glGetUniformLocation(msd_gShaderProgramObject1, "u_la_red");
    msd_ldUniform_red = glGetUniformLocation(msd_gShaderProgramObject1, "u_ld_red");
    msd_lsUniform_red = glGetUniformLocation(msd_gShaderProgramObject1, "u_ls_red");
    msd_lightPositionUniform_red = glGetUniformLocation(msd_gShaderProgramObject1, "u_lightPosition_red");
    msd_laUniform_blue = glGetUniformLocation(msd_gShaderProgramObject1, "u_la_blue");
    msd_ldUniform_blue = glGetUniformLocation(msd_gShaderProgramObject1, "u_ld_blue");
    msd_lsUniform_blue = glGetUniformLocation(msd_gShaderProgramObject1, "u_ls_blue");
    msd_lightPositionUniform_blue = glGetUniformLocation(msd_gShaderProgramObject1, "u_lightPosition_blue");
    msd_laUniform_green = glGetUniformLocation(msd_gShaderProgramObject1, "u_la_green");
    msd_ldUniform_green = glGetUniformLocation(msd_gShaderProgramObject1, "u_ld_green");
    msd_lsUniform_green = glGetUniformLocation(msd_gShaderProgramObject1, "u_ls_green");
    msd_lightPositionUniform_green = glGetUniformLocation(msd_gShaderProgramObject1, "u_lightPosition_green");
...
-(void)drawView:(id)sender
{
    ...
    msd_translationMatrix = vmath::translate(0.0f, 0.0f, -2.0f);
    msd_modelMatrix = msd_translationMatrix;
    ...
    if (msd_gbIsLighting == true)
    {
        ...
        lights[0].LightPosition[3] = 1.0f;
        glUniform3fv(msd_laUniform_red, 1, lights[0].LightAmbience);
        glUniform3fv(msd_ldUniform_red, 1, lights[0].LightDiffuse);
        glUniform3fv(msd_lsUniform_red, 1, lights[0].LightSpecular);
        glUniform4fv(msd_lightPositionUniform_red, 1,lights[0].LightPosition);
        ...
        lights[1].LightPosition[3] = 1.0f;
        glUniform3fv(msd_laUniform_blue, 1, lights[1].LightAmbience);
        glUniform3fv(msd_ldUniform_blue, 1, lights[1].LightDiffuse);
        glUniform3fv(msd_lsUniform_blue, 1, lights[1].LightSpecular);
        glUniform4fv(msd_lightPositionUniform_blue, 1, lights[1].LightPosition);
        ...
        lights[2].LightPosition[3] = 1.0f;
        glUniform3fv(msd_laUniform_green, 1, lights[2].LightAmbience);
        glUniform3fv(msd_ldUniform_green, 1, lights[2].LightDiffuse);
        glUniform3fv(msd_lsUniform_green, 1, lights[2].LightSpecular);
        glUniform4fv(msd_lightPositionUniform_green, 1, lights[2].LightPosition);
