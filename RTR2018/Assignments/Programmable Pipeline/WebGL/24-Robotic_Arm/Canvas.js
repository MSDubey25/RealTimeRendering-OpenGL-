...
function draw()
{
	...
	mat4.rotateZ(rotationMatrix,rotationMatrix,shoulder*Math.PI/180.0);
	...
	gl.vertexAttrib3f(WebGlMacros.AMC_ATTRIBUTE_COLOR, 0.5, 0.35, 0.05);
	sphere.draw();
	...
	mat4.translate(translationMatrix,translationMatrix,[1.0,0.0,0.0]);
	mat4.multiply(modelViewMatrix,modelViewMatrix,translationMatrix);
	mat4.rotateZ(rotationMatrix,rotationMatrix,elbow*Math.PI/180.0);
	mat4.multiply(modelViewMatrix,modelViewMatrix,rotationMatrix);
	mat4.multiply(modelViewMatrix,modelViewMatrix,scaleMatrix);
	translationMatrix=mat4.create();
	mat4.translate(translationMatrix,translationMatrix,[1.1,0.0,0.0]);
	//mat4.multiply(modelViewMatrix,modelViewMatrix,rotationMatrix);
	mat4.multiply(modelViewMatrix,modelViewMatrix,translationMatrix);
	//	mat4.rotateZ(rotationMatrix,rotationMatrix,90.0/180.0);
	//mat4.multiply(modelViewMatrix,modelViewMatrix,rotationMatrix);
	Stack.push(Object.assign({}, modelViewMatrix));
