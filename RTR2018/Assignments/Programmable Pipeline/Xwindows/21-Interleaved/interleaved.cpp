...
void CreateWindow(void)
{
       ...
       XStoreName(gpDisplay,gWindow,"Interleaved");
...
void initialize(void)
{
	...
	const GLchar *vertexShaderSourceCode =
		...
		"		vec3 normalMatrix= normalize(mat3(u_v_matrix*u_m_matrix)*vNormal);" \
	...
	modelMatrix = mat4::identity();	Resize(giWindowWidth,giWindowHeight);
