//
//  GLESView.m
//  07-3D_Texture_Stone_Kundali
//
//  Created by Ajay Arun Pawar on 17/01/20.
//
...
@private
    ...
    GLuint msd_vbo_texture_pyramid;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        //for texture
        glGenBuffers(1, &msd_vbo_texture_pyramid);
        glBindBuffer(GL_ARRAY_BUFFER, msd_vbo_texture_pyramid);
...
-(void)dealloc
{
    ...
    if(msd_vbo_texture_pyramid)
    {
        glDeleteTextures(1,&msd_vbo_texture_pyramid);
        msd_vbo_texture_pyramid=0;
    }
