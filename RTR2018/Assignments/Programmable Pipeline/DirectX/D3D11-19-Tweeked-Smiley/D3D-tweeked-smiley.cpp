...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Direct3D11 Tweeked Smiley"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case VK_ESCAPE:
			DestroyWindow(hwnd);
			break;
		case 49:case VK_NUMPAD1:
			key_pressed = 1;
			break;
		case 50:case VK_NUMPAD2:
			key_pressed = 2;
			break;
		case 51:case VK_NUMPAD3:
			key_pressed = 3;
			break;
		case 52:case VK_NUMPAD4:
			key_pressed = 4;
			break;
		case 48:case VK_NUMPAD0:
			key_pressed = 0;
			break;
		}
		break;
...
void display()
{
	...
	if (key_pressed == 1 )
	{
		...
		rectangleTexCoord[8] = 0.5f;
		rectangleTexCoord[9] = 0.0f;
		rectangleTexCoord[10] = 0.5f;
		rectangleTexCoord[11] = 0.5f;
	}
	else if (key_pressed == 2)
	{
		...
		rectangleTexCoord[8] = 1.0f;
		rectangleTexCoord[9] = 0.0f;
		rectangleTexCoord[10]= 1.0f;
		rectangleTexCoord[11]= 1.0f;
	}
	else if (key_pressed == 3)
	{
		...
		rectangleTexCoord[8] = 2.0f;
		rectangleTexCoord[9] = 0.0f;
		rectangleTexCoord[10] = 2.0f;
		rectangleTexCoord[11] = 2.0f;
	}
	...
	else
	{
		...
		rectangleTexCoord[8] = 0.0f;
		rectangleTexCoord[9] = 0.0f;
		rectangleTexCoord[10] = 0.0f;
		rectangleTexCoord[11] = 0.0f;
	...
	msd_gpID3D11DeviceContext->Map(gpID3D11Buffer_VertexBuffer_Texture_Cube, 0,
		D3D11_MAP_WRITE_DISCARD, 0, &mappedSubResource_tex);
	memcpy(mappedSubResource_tex.pData, rectangleTexCoord, sizeof(rectangleTexCoord));
	msd_gpID3D11DeviceContext->Unmap(gpID3D11Buffer_VertexBuffer_Texture_Cube, NULL);
