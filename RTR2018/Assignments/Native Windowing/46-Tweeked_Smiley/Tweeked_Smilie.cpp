...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Tweeked Smiliey"),
...
int initialize(void)
{
	...
	LoadTexture(&texture_smilie, MAKEINTRESOURCE(ID_SMILIE));
	return 0;
}
...
void Display(void)
{
	...
	if (key_pressed == 1)
	{
		glBindTexture(GL_TEXTURE_2D, texture_smilie);
		glBegin(GL_QUADS);
