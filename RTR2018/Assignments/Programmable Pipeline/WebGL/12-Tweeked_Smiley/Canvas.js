...
function init()
{
	...
	rectangle_texture.image.onload=function(){
		...
		//gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL,true); //since the image is not flipped vertically so it is commented
...
function draw()
{
	...
	if(keypress==1)
		{
			rectangleTexCoord[0]= 0.5;
			rectangleTexCoord[1]= 0.5;
			rectangleTexCoord[2]= 0.0;
			rectangleTexCoord[3]= 0.5;
			rectangleTexCoord[4]= 0.0;
			rectangleTexCoord[5]= 0.0;
			rectangleTexCoord[6]= 0.5;
			rectangleTexCoord[7]= 0.0;
			
		}
		else if(keypress==2)
		{
			rectangleTexCoord[0]= 1.0;
			rectangleTexCoord[1]= 1.0;
			rectangleTexCoord[2]= 0.0;
			rectangleTexCoord[3]= 1.0;
			rectangleTexCoord[4]= 0.0;
			rectangleTexCoord[5]= 0.0;
			rectangleTexCoord[6]= 1.0;
			rectangleTexCoord[7]= 0.0;
			
		}
		else if(keypress==3)
		{
			rectangleTexCoord[0]= 2.0;
			rectangleTexCoord[1]= 2.0;
			rectangleTexCoord[2]= 0.0;
			rectangleTexCoord[3]= 2.0;
			rectangleTexCoord[4]= 0.0;
			rectangleTexCoord[5]= 0.0;
			rectangleTexCoord[6]= 2.0;
			rectangleTexCoord[7]= 0.0;
		...
		else if(keypress==4)
		{
			rectangleTexCoord[0]= 0.5;
			rectangleTexCoord[1]= 0.5;
			rectangleTexCoord[2]= 0.5;
			rectangleTexCoord[3]= 0.5;
			rectangleTexCoord[4]= 0.5;
			rectangleTexCoord[5]= 0.5;
			rectangleTexCoord[6]= 0.5;
			rectangleTexCoord[7]= 0.5;
			
		}
		else
		{
			rectangleTexCoord[0]= 0.0;
			rectangleTexCoord[1]= 0.0;
			rectangleTexCoord[2]= 0.0;
			rectangleTexCoord[3]= 0.0;
			rectangleTexCoord[4]= 0.0;
			rectangleTexCoord[5]= 0.0;
			rectangleTexCoord[6]= 0.0;
			rectangleTexCoord[7]= 0.0;
			
		}
	gl.bindBuffer(gl.ARRAY_BUFFER,vbo_texture);
	gl.bufferData(gl.ARRAY_BUFFER,new Float32Array(rectangleTexCoord),gl.DYNAMIC_DRAW);
	gl.vertexAttribPointer(WebGlMacros.AMC_ATTRIBUTE_TEXTURE,2,gl.FLOAT,false,0,0);
	gl.enableVertexAttribArray(WebGlMacros.AMC_ATTRIBUTE_TEXTURE);
	gl.bindBuffer(gl.ARRAY_BUFFER,null);
	gl.bindVertexArray(vao_rectangle);
