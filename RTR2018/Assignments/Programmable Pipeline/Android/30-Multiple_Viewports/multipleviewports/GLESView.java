package com.astromedicomp.multipleviewports;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	//upto wglMakeCurrent is taken care by GLSurfaceView
		...
		//To create Buffer data from out array
		//step1:Allocate the buffer directly from native memory
		ByteBuffer byteBufferC=ByteBuffer.allocateDirect((traingleColor.length)*4);
		//step2:Arange the buffer into native ByteOrder
		...
		GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER,(traingleColor.length)*4,
	...
	private void Display()
	{
		...
		case 0:
			...
			System.out.println("RTR:count of tap :"+count);
			break;
		case 1:
			GLES32.glViewport(0, 0, w / 2, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 2:
			GLES32.glViewport(w / 2, 0, w / 2, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 3:
			GLES32.glViewport(w / 2, h / 2, w / 2, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 4:
			GLES32.glViewport(0, h / 2, w / 2, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 5:
			GLES32.glViewport(0, 0, w / 2, h);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 6:
			GLES32.glViewport(w / 2, 0, w / 2, h);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 7:
			GLES32.glViewport(0, h / 2, w, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 8:
			GLES32.glViewport(0, 0, w, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		case 9:
			GLES32.glViewport(w / 4, h / 4, w / 2, h / 2);
			System.out.println("RTR:count of tap :"+count);
			break;
		default:
			GLES32.glViewport(0, 0, w, h);
