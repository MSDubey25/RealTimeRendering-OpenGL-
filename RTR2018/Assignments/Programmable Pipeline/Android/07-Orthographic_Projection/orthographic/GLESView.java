package com.astromedicomp.orthographic;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	//upto wglMakeCurrent is taken care by GLSurfaceView
		...
		/*System.out.println("RTR:orthographicProjectionMatrix ---->");
		for(int i=0;i<16;i++)
		{
			System.out.print(orthographicProjectionMatrix[i]);
		}*/
	...
	private void Resize(int width,int height)
	{
		...
		if (width <= height)
		{
			Matrix.orthoM(orthographicProjectionMatrix,0,-100,
				100,
				(-100*height /width),
				(100*height / width),
				-100,
				100);
			/*	System.out.println("RTR:in Resize orthographicProjectionMatrix ---->"+orthographicProjectionMatrix);
				for(int i=0;i<16;i++)
				{
					System.out.print(orthographicProjectionMatrix[i]);
				}*/
		...
		{
			Matrix.orthoM(orthographicProjectionMatrix,0,(-100*width / height),
				(100*width / height),
				-100,
				100,
				-100,
	...
	/*	System.out.println("RTR:identity modelViewProjectionMatrix ---->"+modelViewProjectionMatrix);
		for(int i=0;i<16;i++)
		{
			System.out.print(modelViewProjectionMatrix[i]+" ,");
		}*/
		Matrix.setIdentityM(modelViewMatrix,0);
		/*System.out.println("RTR:identity modelViewMatrix ---->"+modelViewMatrix);
		for(int i=0;i<16;i++)
		{
			System.out.print(modelViewMatrix[i]+" ,");
		}*/
		/*System.out.println("RTR:orthographicProjectionMatrix i Dispalays---->"+modelViewMatrix);
		for(int i=0;i<16;i++)
		{
			System.out.print(orthographicProjectionMatrix[i]+" ,");
		}*/
