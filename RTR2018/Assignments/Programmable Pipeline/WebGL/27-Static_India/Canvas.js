...
function draw()
{
	...
	mat4.translate(modelViewMatrix,modelViewMatrix,[0.15, 0.0, -3.0]);
	mat4.scale(modelViewMatrix,modelViewMatrix,[0.8, 0.9, 0.0]);
	mat4.multiply(modelViewProjectionMatrix,perspectiveProjectionMatrix,modelViewMatrix);
	gl.uniformMatrix4fv(mvpUniform,false,modelViewProjectionMatrix);
	//similarly bind with textures if any
	...
	mat4.translate(modelViewMatrix,modelViewMatrix,[0.1, 0.0, -3.0]);
	mat4.scale(modelViewMatrix,modelViewMatrix,[0.8, 0.9, 0.0]);
	mat4.multiply(modelViewProjectionMatrix,perspectiveProjectionMatrix,modelViewMatrix);
	gl.uniformMatrix4fv(mvpUniform,false,modelViewProjectionMatrix);
	//similarly bind with textures if any
	...
	mat4.translate(modelViewMatrix,modelViewMatrix,[1.6, 0.0, -3.0]);
	mat4.scale(modelViewMatrix,modelViewMatrix,[0.8, 0.9, 0.0]);
	mat4.multiply(modelViewProjectionMatrix,perspectiveProjectionMatrix,modelViewMatrix);
	gl.uniformMatrix4fv(mvpUniform,false,modelViewProjectionMatrix);
	...
	mat4.translate(modelViewMatrix,modelViewMatrix,[0.8555, 0.0, -3.0]);
	mat4.scale(modelViewMatrix,modelViewMatrix,[0.8, 0.9, 0.0]);
	mat4.multiply(modelViewProjectionMatrix,perspectiveProjectionMatrix,modelViewMatrix);
	gl.uniformMatrix4fv(mvpUniform,false,modelViewProjectionMatrix);
	...
	mat4.translate(modelViewMatrix,modelViewMatrix,[0.957, 0.0, -3.0]);
