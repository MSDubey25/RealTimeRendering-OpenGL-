...
void Display(void)
{
	...
	translationMatrix = translate(-2.0f + counter1, 0.0f, -4.0f);
	...
	modelViewMatrix = mat4::identity();
	translationMatrix = mat4::identity();
	translationMatrix = translate(0.2f, 6.5f - counter3, -4.0f);
	...
	modelViewMatrix = mat4::identity();
	translationMatrix = mat4::identity();
	translationMatrix = translate(2.15f, -2.5f + counter4, -4.0f);
	modelViewMatrix = translationMatrix * modelViewMatrix;
	//do necessary matrix multiplication
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
	...
	modelViewMatrix = mat4::identity();
	translationMatrix = mat4::identity();
	translationMatrix = translate(2.05f - counter2, 0.0f, -4.0f);
	modelViewMatrix = translationMatrix *modelViewMatrix;
	//do necessary matrix multiplication
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
	...
	if (flagI1 == true && flagA==true && flagN==true && flagI2==true && Cr >= 1.0f && Cg>=0.6f && Cb>=0.2f)
	{
		...
		modelViewMatrix = mat4::identity();
		translationMatrix = mat4::identity();
		translationMatrix = translate(0.95f, 0.0f, -3.0f);
		...
		modelViewMatrix = mat4::identity();
		translationMatrix = mat4::identity();
		translationMatrix = translate(1.05f, 0.0f, -3.0f);
		modelViewMatrix = translationMatrix * modelViewMatrix;
		//do necessary matrix multiplication
		modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
...
void DrawPlane()
{
   ...
   -0.05f, 0.2f , 0.0f
	...
	translationMatrix = mat4::identity();
	modelViewMatrix = mat4::identity();
	translationMatrix = translate(0.97f,0.0f,-2.5f);
	...
	translationMatrix = mat4::identity();
	modelViewMatrix = mat4::identity();
	translationMatrix = translate(1.0f, 0.0f, -2.5f);
	modelViewMatrix = modelViewMatrix * translationMatrix*scaleMatrix;
	//do necessary matrix multiplication
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
	...
	translationMatrix = mat4::identity();
	modelViewMatrix = mat4::identity();
	translationMatrix = translate(0.77f, 0.0f, -2.5f);
	modelViewMatrix = modelViewMatrix * translationMatrix*scaleMatrix;
	//do necessary matrix multiplication
	modelViewProjectionMatrix = perspectiveProjectionMatrix * modelViewMatrix;
