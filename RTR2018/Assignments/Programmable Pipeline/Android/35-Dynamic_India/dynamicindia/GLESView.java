...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener
{
	...
	static float counterP1 = 0.0f;
	static float xTranslate = 0.0f;
	static float timer = 0.0f;

	static Boolean flagI1 = false;
	static Boolean flagA = false;
	static Boolean flagN = false;
	static Boolean flagI2 = false;
	static Boolean flagD = false;
	static float Cr = 0.0f, Cg = 0.0f, Cb = 0.0f;
	static float Gr = 0.0f, Gg = 0.0f, Gb = 0.0f;
	...
	1.0f, 0.6f, 0.2f
		...
		Matrix.translateM(translationMatrix,0,-2.0f + counter1,0.0F,-3.0F);
		...
		Matrix.setIdentityM(modelViewMatrix,0);
		/////////////////////////// N /////////////////
		Matrix.translateM(translationMatrix,0,0.2f, 6.5f - counter3, -3.0f);
		Matrix.multiplyMM(modelViewMatrix,0,modelViewMatrix,0,translationMatrix,0);
		//Matrix.multiplyMM(modelViewMatrix,0,modelViewMatrix,0,rotationMatrix,0);
		Matrix.multiplyMM(modelViewProjectionMatrix,0,perspectiveProjectionMatrix,0,modelViewMatrix,0);
		/*System.out.println("RTR:Afetr Multiplication matrix is ---->"+modelViewProjectionMatrix);
		...
		Matrix.setIdentityM(modelViewMatrix,0);
		Matrix.setIdentityM(translationMatrix,0);
		Matrix.translateM(translationMatrix,0,0.2f, 0.0f, -3.0f);
		Matrix.multiplyMM(modelViewMatrix,0,modelViewMatrix,0,translationMatrix,0);
		//Matrix.multiplyMM(modelViewMatrix,0,modelViewMatrix,0,rotationMatrix,0);
		Matrix.multiplyMM(modelViewProjectionMatrix,0,perspectiveProjectionMatrix,0,modelViewMatrix,0);
		/*System.out.println("RTR:Afetr Multiplication matrix is ---->"+modelViewProjectionMatrix);
	...
	///////////////////////// I ////////////////
		Matrix.setIdentityM(modelViewMatrix,0);
		Matrix.setIdentityM(translationMatrix,0);
		Matrix.translateM(translationMatrix,0,2.15f, -2.5f + counter4, -3.0f);
		//Matrix.rotateM(rotationMatrix,0,angle_traingle,0.0F,1.0F,0.0F);
		...
		Matrix.setIdentityM(modelViewMatrix,0);
		Matrix.setIdentityM(translationMatrix,0);
			Matrix.translateM(translationMatrix,0,2.05f - counter2, 0.0f, -3.0f);
		//Matrix.rotateM(rotationMatrix,0,angle_traingle,0.0F,1.0F,0.0F);
		...
		Matrix.setIdentityM(modelViewMatrix,0);
		////flag
			Matrix.translateM(translationMatrix,0,1.24f, 0.0f,-3.0F);
		//Matrix.rotateM(rotationMatrix,0,angle_traingle,0.0F,1.0F,0.0F);
	...
	for (int i = 0; i < 1000; i++)
	{
		...
		Matrix.setIdentityM(translationMatrix,0);
		Matrix.setIdentityM(modelViewMatrix,0);
		Matrix.translateM(translationMatrix,0,1.38F,0.0F,-3.0F);
		//Matrix.rotateM(rotationMatrix,0,angle_traingle,0.0F,1.0F,0.0F);
