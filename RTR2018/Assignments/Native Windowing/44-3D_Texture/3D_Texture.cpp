...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("3D Texture"),
...
void Display(void)
{
	...
	//top
	glTexCoord2f(0.0f, 1.0f);//apex
	glVertex3f(-1.0f, 1.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f);//apex
	glVertex3f(1.0f, 1.0f, 1.0f);
	glTexCoord2f(1.0f, 0.0f);//apex
	glVertex3f(1.0f, 1.0f, -1.0f);
	glTexCoord2f(1.0f, 1.0f);//apex
	glVertex3f(-1.0f, 1.0f, -1.0f);
	//bottom
	glTexCoord2f(1.0f, 1.0f);//apex
	glVertex3f(-1.0f, -1.0f, 1.0f);
