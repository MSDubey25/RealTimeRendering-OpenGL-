...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Tweeked Smiley"),
...
int initialize(void)
{
	...
	glBufferData(GL_ARRAY_BUFFER, 4 * sizeof(GL_FLOAT),
	...
	LoadTexture(&texImage, MAKEINTRESOURCE(ID_SMILIE));
	return 0;
}
BOOL LoadTexture(GLuint *texture, TCHAR imageResourceID[])
{
...
void Display(void)
{
	...
	//select the texcoord on button press
	if (key_pressed == 1)
	{
