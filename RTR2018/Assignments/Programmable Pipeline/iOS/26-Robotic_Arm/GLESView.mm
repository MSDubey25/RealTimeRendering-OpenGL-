...
-(void)drawView:(id)sender
{
    ...
    msd_translationMatrix = vmath::translate(0.0f, 0.0f, -8.0f);
    msd_modelViewMatrix = msd_translationMatrix * msd_modelViewMatrix;
    
    
    
    sp.pushMatrix(msd_modelViewMatrix);
    
    msd_rotationMatrix = vmath::rotate((float)shoulder, 0.0f, 0.0f, 1.0f);
    ...
    msd_scaleMatrix = vmath::scale(2.0f, 0.5f, 1.0f);
    msd_modelViewMatrix = msd_modelViewMatrix * msd_scaleMatrix;
    ...
    msd_modelViewMatrix = sp.popMatrix();
    ...
    msd_rotationMatrix = vmath::mat4::identity();
    msd_rotationMatrix = vmath::rotate((float)elbow, 0.0f, 0.0f, 1.0f);
    msd_modelViewMatrix = msd_modelViewMatrix * msd_rotationMatrix;
