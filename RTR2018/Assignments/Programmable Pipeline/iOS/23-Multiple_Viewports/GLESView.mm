...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        glBufferData(GL_ARRAY_BUFFER,sizeof(triangleColor),
                     triangleColor,GL_STATIC_DRAW);
