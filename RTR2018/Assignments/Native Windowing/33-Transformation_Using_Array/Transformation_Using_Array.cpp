...
int initialize(void)
{
	...
	for (int i = 0; i < 16; i++)
	{
		if (i == 0 || i == 5 || i == 10 || i == 15)
			Identity[i] = Translate[i]=Rotate[i]=1.0f;
		else
			Identity[i] =Translate[i]=Rotate[i] = 0.0f;
	}
	fprintf(gpFile, "Identity matrix\n");
	for (int i = 0; i < 16; i++)
		fprintf(gpFile, "%f\t", Identity[i]);
	fprintf(gpFile, "Translate matrix\n");
	for (int i = 0; i < 16; i++)
		fprintf(gpFile, "%f\t", Translate[i]);
	fprintf(gpFile, "Rotate matrix\n");
	for (int i = 0; i < 16; i++)
		fprintf(gpFile, "%f\t", Rotate[i]);
