...
ID3D11Buffer *gpID3D11Buffer_ColorBuffer_Cube = NULL;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow)
{
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW, szAppName, TEXT("Direct3D11 Cube"), WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_CLIPSIBLINGS | WS_VISIBLE, 100, 100, WIN_WIDTH, WIN_HEIGHT, NULL, NULL, hInstance, NULL);
...
HRESULT initialize()
{
	...
	hr = msd_gpID3D11Device->CreateBuffer(&bufferDesc_ColorBuffer_Cube, NULL, &gpID3D11Buffer_ColorBuffer_Cube);
	if (FAILED(hr))
	{
	...
	msd_gpID3D11DeviceContext->Map(gpID3D11Buffer_ColorBuffer_Cube,0,
	...
	msd_gpID3D11DeviceContext->Unmap(gpID3D11Buffer_ColorBuffer_Cube,NULL);
...
void display()
{
	...
	msd_gpID3D11DeviceContext->IASetVertexBuffers(0, 1, &gpID3D11Buffer_VertexBuffer_Cube,
		&stride, &offset);
	msd_gpID3D11DeviceContext->IASetVertexBuffers(1, 1, &gpID3D11Buffer_ColorBuffer_Cube,
		&stride, &offset);
...
void uninitialize()
{
	...
	if (gpID3D11Buffer_ColorBuffer_Cube)
	{
		gpID3D11Buffer_ColorBuffer_Cube->Release();
		gpID3D11Buffer_ColorBuffer_Cube = NULL;
	}
